...
//Expresion del menu de opciones segun sea un grafo dirigido o no dirigido ç
    ...
    if (dirigido == 0) { //Grafo no dirigido
	    ...
	    //Aqui se añaden mas opciones al mene del grafo no dirigido
    }
    else {
            cout << "i. Mostrar [i]nformacion basica del grafo" << endl;
...
int main(int argc, char *argv[]) {
    ...
    if (error_apertura == 1) {
        ...
        do {
		 ...
		 //Situar aqui el esto de opciones del menu
            }
    }
    while (opcion != 'q');
    }
